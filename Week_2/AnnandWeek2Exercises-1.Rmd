...
diff_days <- difftimes(max(sales$Order.Date), min(sales$Order.Date), units="days")
...
```{r}
# Your code here
temp_char <- stringr::str_split_fixed(string=sales$Customer.Name,pattern=' ',n=2)

customers_bill <- grep("Bill", temp_char[, 1])
